...
<style>
    ...
    .custom-card {
        ...
        border-radius: 15px; /* Adjust the border-radius for a more rounded appearance */
        padding: 2rem;
        margin: 6rem auto;
        overflow: hidden;
        width: 60vh;
...
<div class="row justify-content-center mt-4">
    <div class="">
        <div class="card custom-card">
            <div class="card-body">
                <h4 class="card-title custom-card-title">Tambah Kategori</h4>
                <form class="forms-sample" method="post" action="{{ route('kategori.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Kategori Baru">
                    </div>
